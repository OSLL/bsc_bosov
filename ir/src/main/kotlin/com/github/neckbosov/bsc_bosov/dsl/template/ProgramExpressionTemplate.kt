...
@Serializable
class BracketsExprTemplate<LanguageTag : ProgramLanguageTag>(
    val innerExpr: ProgramExpressionTemplate<LanguageTag>
) : ProgramExpressionTemplate<LanguageTag>() {
    override fun fillItem(random: Random, attributes: ProgramAttributes): BracketsExpr<LanguageTag> {
        return BracketsExpr(this.innerExpr.fillItem(random, attributes))
    }
}
